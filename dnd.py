...
class Dragged:
    ...
    def __init__(self, name, component):
        ...
        self.Compound = component['compound']
        self.Font = component['font']
        self.Command = component['command']
        self.Bg = component['bg']
        self.Fg = component['fg']
    ...
    def dnd_end(self, Target, Event):
        ...
        if self.Canvas == None and self.OriginalCanvas <> None:
            ...
            self.Label['font'] = self.OriginalFont
            self.Label['command'] = self.OriginalCommand
            self.Label['bg'] = self.OriginalBg
            self.Label['fg'] = self.OriginalFg
            self.Label['width'] = self.OriginalWidth
            self.Label['height'] = self.OriginalHeight
        ...
        if self.OriginalCanvas:
            ...
            self.OriginalCompound= None
            self.OriginalFont= None
            self.OriginalCommand= None
            self.OriginalBg= None
            self.OriginalFg= None
    ...
    def Vanish(self, All=0):
        ...
        if All and self.OriginalCanvas:
            ...
            del self.OriginalCompound
            del self.OriginalFont
            del self.OriginalCommand
            del self.OriginalBg
            del self.OriginalFg
            del self.OriginalWidth
            del self.OriginalHeight
    ...
    def Press(self, Event):
        ...
        self.OriginalCompound= self.OriginalLabel['compound']
        self.OriginalFont= self.OriginalLabel['font']
        self.OriginalCommand= self.OriginalLabel['command']
        self.OriginalBg= self.OriginalLabel['bg']
        self.OriginalFg= self.OriginalLabel['fg']
        self.OriginalWidth= self.OriginalLabel['width']
        self.OriginalHeight= self.OriginalLabel['height']
